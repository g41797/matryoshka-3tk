...
**Version 004, superseding
[3tk-example-rules-003.md](backup/3tk-example-rules-003.md)
(now in this repo's `backup/`).** The only change from `003`: 3tk has exactly
two terms: **`Inner`**, a real C3 type and the field you lend, and
