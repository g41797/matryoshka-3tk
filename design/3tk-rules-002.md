...
**Written by `3TK-67`, 2026-09-08. This is `002`, by `3TK-70`, 2026-09-09**,
which rewrote Rules 2, 3 and 4 for the module split and left every other rule
untouched. `001` is in this repo's `backup/`, which is transient. Normative, like
