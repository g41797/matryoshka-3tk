...
**This is 005.** It carries all of `004` and fixes one example: Part 1's *Usual
...
see [3tk-patterns-002.md](3tk-patterns-002.md) entry 14. The walkthrough now
...
2. **Transport.**
   ...
   - `mtk::managed::create` allocates on the heap, writes the identity, and
     ...
     [3tk-patterns-002.md](3tk-patterns-002.md) entry 14.
