...
**Written by `3TK-67`, 2026-09-08. This is `003`, by `3TK-71`, 2026-09-09**,
which added Rule 6 — the test trees allocate their outers — and renumbered the
five stage rules 6–10 into 7–11 to keep it inside Part 1. Nothing else changed:
Rules 1–5 and the text of every stage rule are `002`'s, word for word. `002` and
`001` are in this repo's `backup/`, which is transient. Normative, like
...
[3tk-example-rules-004.md](3tk-example-rules-004.md) governs with an absolute
