# 3tk — API verification table, 006

**006 replaces 005, written by 3TK-78 on 2026-09-14**, which added `Mailbox.send`'s
...
[3tk-reference-012.md](3tk-reference-012.md) is that page, and it is the one a
