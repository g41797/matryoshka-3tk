...
version goes to `backup/`. **This is `006`**, written by `3TK-60`, which
retired the words *handle* and *item* and left 3tk with exactly two terms;
`005` is in `matryoshka-tk`'s `design/secondary/lang/c3/backup/`.
